	...
	function group_management() {
		...
		if ($groups) {
			...
			foreach ($groups as $group) {
				echo "<tr><td><a href='?page=password_vault_settings&action=group_management&sub_action=delete&group_id={$group->group_id}'><img src='../wp-content/plugins/password-vault/x.png' width='10' height='10' border='0'></a></td><td>{$group->group_name}</td></tr>";
			}
			echo "</table>";
		}
